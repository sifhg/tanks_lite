    ...
    constructor(arg0, arg1) {
        ...
        this.Tank = class {
            constructor(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11) {
                ...
                this._gun = new this._turretAssembly.Sprite(this._turret.x, this._turret.y +
                    (parameterInitializers.barrelLength * p5Tanks.DISTANCE_SCALAR) / 2 +
                    (this._hull.halfWidth * 2) / 3, (calibre + 0.08) * p5Tanks.DISTANCE_SCALAR, parameterInitializers.barrelLength * p5Tanks.DISTANCE_SCALAR, "none");
                this._joints = {
...
p5Tanks.prototype.registerMethod("pre", function applySideDragForce() {
    for (const P of p5Tanks.INSTANCES) {
        for (const TANK of P.TANKS) {
            ...
            const FORCE_MAGNITUDE = Math.abs(P.sin(TANK.motionDirection - TANK.direction)) *
                TANK.speed *
                5000;
