...
declare module '../../index' {
    class Vector {
         ...
         *   @return The distance
         */
        static dist(v1x: number, v1y: number, v2x: number, v2y: number): number;
        static dist(v1: Vector, v2x: number, v2y: number): number;
        static dist(v1x: number, v1y: number, v2: Vector): number;
