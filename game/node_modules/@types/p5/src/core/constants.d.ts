...
declare module '../../index' {
    interface p5InstanceExtensions {
         ...
         *   p5play classes.
         */
        readonly Camera: class;
        readonly Canvas: class;
        readonly DistanceJoint: class;
        readonly GlueJoint: class;
        readonly Group: class;
        readonly GroupSprite: class;
        readonly Subgroup: class;
        readonly HingeJoint: class;
        readonly InputDevice: class;
        readonly Joint: class;
        readonly P5Play: class;
        readonly RopeJoint: class;
        readonly SliderJoint: class;
        readonly Sprite: class;
        readonly SpriteAnimation: class;
        readonly Tiles: class;
        readonly WheelJoint: class;
        readonly World: class;
        readonly _Contro: class;
        readonly _Contros: class;
        readonly _KeyBoard: class;
        readonly _Mouse: class;
        readonly _SpriteMouse: class;
