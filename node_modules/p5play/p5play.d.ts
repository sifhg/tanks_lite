...
class Sprite {
     ...
     * sprite.applyForce({x, y}, {x: originX, y: originY});
     */
    applyForce(amount: number);
    applyForce(amount: number, origin: {x: number, y: number});
    applyForce(x: number, y: number);
    applyForce(x: number, y: number, origin: {x: number, y: number});
    applyForce(amount: {x: number, y: number}, origin: {x: number, y: number});
