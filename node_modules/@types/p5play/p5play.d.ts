...
class Sprite {
     ...
     * sprite.applyForce({x, y}, {x: originX, y: originY});
     */
    applyForce(amount: number|{x: number, y: number}): void;
    applyForce(amount: number|{x: number, y: number}, origin: {x: number, y: number}): void;
    applyForce(x: number, y: number): void;
    applyForce(x: number, y: number, {x: originX, y: originY}): void;
    applyForce(amount: {x: number, y: number}, origin: {x: number, y: number}): void;
